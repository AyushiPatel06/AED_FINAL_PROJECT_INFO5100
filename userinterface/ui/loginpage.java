...
import Business.covidtaskforce.CovidTaskForceDirectory;
...
import Business.cardiacemergency.CardiacEmergency_Directory;
...
public class loginpage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images_new/heart_logo4.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images_new/login 10.jpg"))); // NOI18N
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 20, -1, 110));
        ...
        jButton1.setFont(new java.awt.Font("Lucida Fax", 2, 16)); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images_new/password.png"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 270, 40, 40));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images_new/user logo.png"))); // NOI18N
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 180, 30, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images_new/title_1.PNG"))); // NOI18N
        ...
        jButton2.setFont(new java.awt.Font("Lucida Fax", 2, 16)); // NOI18N
...
//            else if(a.equals("Business.Role.bloodbankadminrole"))
            else if(a.equals("Business.Role.devicebankadminrole"))
            {
                devicebank_directory cd=system.getBloodbankdirectory();
                ArrayList<DeviceBank> c=cd.getA();
                int size=c.size();
                System.out.println(c.size());
                int count=0;
                for(int i=0;i<size;i++)
                {
                DeviceBank c1=c.get(i);
            ...
            else if(a.equals("Business.Role.CardiacEmergencyRole"))
            {
                CardiacEmergency_Directory cd=system.getPd();
                ArrayList<CardiacEmergency> c=cd.getA();
                int size=c.size();
                System.out.println(c.size());
                int count=0;
                for(int i=0;i<size;i++)
                {
                CardiacEmergency c1=c.get(i);
                if(userAccount.getUsername().matches(c1.getUserid()))
                {
                callpolice();
                count+=1;
            ...
            else if(a.equals("Business.Role.CovidTaskForceAdmin"))   
            {
                CovidTaskForceDirectory cd=system.getFd();
                ArrayList<CovidTaskForce> c=cd.getA();
                int size=c.size();
                System.out.println(c.size());
                int count=0;
                for(int i=0;i<size;i++)
                {
                CovidTaskForce c1=c.get(i);
                if(userAccount.getUsername().matches(c1.getUserid()))
                {
                callfire();
                count+=1;
    ...
    {
        covidtaskforceframe ur=new covidtaskforceframe(container,system,userAccount);
        container.add(ur);
        CardLayout layout = (CardLayout) container.getLayout();
        layout.next(container); 
    }
    ...
    {
        cardiacemergency_frame ur=new cardiacemergency_frame(container,system,userAccount);
        container.add(ur);
        CardLayout layout = (CardLayout) container.getLayout();
        layout.next(container); 
    }
    ...
    {
        devicebankframe ur=new devicebankframe(container,system,userAccount);
        container.add(ur);
        CardLayout layout = (CardLayout) container.getLayout();
        layout.next(container); 
    }
