 ...
 */
public class devicebank extends javax.swing.JPanel {
     ...
     */
    public devicebank(JPanel container,EcoSystem system) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if( jTextField1.getText().isEmpty()||jTextField2.getText().isEmpty()|| jTextField3.getText().isEmpty() || jTextField5.getText().isEmpty() || jTextField4.getText().isEmpty())
        {
         ...
         if(system.getUserAccountDirectory().checkIfUsernameIsUnique(jTextField4.getText())){
            ...
            DeviceBank customer = new DeviceBank(jTextField1.getText(),jTextField4.getText(), jTextField5.getText(),  jTextField3.getText(),jTextField2.getText() );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        devicebank_directory bbd = system.getBloodbankdirectory();
        ArrayList<DeviceBank> cd1=bbd.getA();
        int z=cd1.size();
        for(int i=0;i<z;i++)
        {
             DeviceBank c=cd1.get(i);
             c.getUsername();
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
        for (DeviceBank customer : bbd.getA()) {
