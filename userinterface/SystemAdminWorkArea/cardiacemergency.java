 ...
 */
public class cardiacemergency extends javax.swing.JPanel {
     ...
     */
    public cardiacemergency(JPanel container,EcoSystem system) {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        CardiacEmergency_Directory pd = system.getPd();
        ArrayList<CardiacEmergency> cd1=pd.getA();
        int z=cd1.size();
        for(int i=0;i<z;i++)
        {
            CardiacEmergency c=cd1.get(i);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(system.getUserAccountDirectory().checkIfUsernameIsUnique(jTextField4.getText())){
            ...
            CardiacEmergency customer = new CardiacEmergency(jTextField1.getText(),jTextField4.getText(), jTextField5.getText(),  jTextField3.getText(),jTextField2.getText() );
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
        for (CardiacEmergency customer: pd.getA()) {
