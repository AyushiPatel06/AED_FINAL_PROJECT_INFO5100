 ...
 */
public class covidtaskforcedept extends javax.swing.JPanel {
     ...
     */
    public covidtaskforcedept(JPanel container,EcoSystem system) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(system.getUserAccountDirectory().checkIfUsernameIsUnique(jTextField4.getText())){
            ...
            CovidTaskForce customer = new CovidTaskForce(jTextField1.getText(),jTextField4.getText(), jTextField5.getText(),  jTextField3.getText(),jTextField2.getText() );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        CovidTaskForceDirectory pd = system.getFd();
        ArrayList<CovidTaskForce> cd1=pd.getA();
        int z=cd1.size();
        for(int i=0;i<z;i++)
        {
            CovidTaskForce c=cd1.get(i);
            c.getUsername();
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
        for (CovidTaskForce customer : pd.getA()) {
