 ...
 * @author maury
 */
public class Device_bank extends javax.swing.JPanel {
     ...
     */
    public Device_bank(JPanel container,EcoSystem ecosystem,UserAccount userAccount) {
        initComponents();
        ...
        devicebank_directory bd=ecosystem.getBloodbankdirectory();
        ArrayList<DeviceBank> ol=bd.getA();
        int u=ol.size();
        for(int i=0;i<u;i++)
        {
            DeviceBank o=ol.get(i);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Device Bank Name :");
        ...
        jLabel6.setText("User Registration for Device Bank");

        jLabel7.setForeground(new java.awt.Color(204, 204, 204));
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images_new/Logo All Page .png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            {
            Register_device db=new Register_device();
            ...
            if(d1.compareTo(d2.toString()) >= 0) {
                Register_device_Directory dbd=ecosystem.getDbd();    
                dbd.addrequest(db);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Register_device_Directory red=ecosystem.getDbd();
        ArrayList<Register_device> ol=red.getarray();
        int u=ol.size();
        User bb=(User)(userAccount);
        for(int i=0;i<u;i++)
        {
            Register_device o=ol.get(i);
