 ...
 */
package userinterface.covidtaskforce;
 ...
 * @author ayushi
 */
public class covidtaskforceframe extends javax.swing.JPanel {
     ...
     */
    public covidtaskforceframe(JPanel container,EcoSystem system,UserAccount userAccount) {
        initComponents();
    ...
    public void populate_table()
    {
        ...
        for(int i=0;i<u;i++)
        {
            ...
            System.out.println("O$$$$$$ >" + o.getEmergency());
            if(o.getEmergency().matches("Covid Task Force"))
            {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        ArrayList<report_emergency> ol=red.getUser();
        int u=ol.size();
        CovidTaskForce a=(CovidTaskForce)userAccount;
        for(int i=0;i<u;i++)
        {
            report_emergency o=ol.get(i);
