 ...
 */
package userinterface.cardiacemergencyframe;
 ...
 * @author ayushi
 */
public class cardiacemergency_frame extends javax.swing.JPanel {
     ...
     */
    public cardiacemergency_frame(JPanel container,EcoSystem system,UserAccount userAccount) {
        initComponents();
        this.container=container;
        this.system=system;
        this.userAccount=userAccount;
        CardiacEmergency p=(CardiacEmergency)userAccount;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images_new/cardiac_rapid_response.png"))); // NOI18N
        ...
        jButton2.setText("False Request");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int u=ol.size();
        CardiacEmergency a=(CardiacEmergency)userAccount;
        for(int i=0;i<u;i++)
        {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(int i=0;i<u;i++)
        {
            ...
            if(s==o.getID()/*&&o.getStatus().matches("Deliver Man Assigned")*/)
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Emergency is a false Alarm");
                }
                else if(o.getResponse().matches("No Response"))
                {
    ...
    public void populate_table()
    {
        ...
        {
            report_emergency o=ol.get(i);
            if(o.getEmergency().matches("Cardiac Emergency"))
            {
